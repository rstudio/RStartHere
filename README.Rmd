...
* [officer](https://davidgohel.github.io/officer/) - creates rich, template-based MS Word and MS PowerPoint documents directly from R (Office is not necessary).
* [flextable](https://davidgohel.github.io/flextable/) - creates advanced, highly customizable tables, supporting cell merge, multi-level headers and conditional formatting, ready to embed in MS Word and MS PowerPoint documents via the officer package.
